(function ($) {
    ...
    // Register ScrollSmoother (premium plugin dari ThemeForest)
    if (window.gsap && window.ScrollSmoother) {
        try {
            ...
            console.warn('ScrollSmoother registration failed:', e);
        }
    }

    // Register SplitText (premium plugin dari ThemeForest)
    ...
    // TweenMax sudah deprecated di GSAP 3.x - menggunakan gsap langsung
